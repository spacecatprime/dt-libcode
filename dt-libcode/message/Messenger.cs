...
namespace dtlibcode
{
	...
	*/
	static public class Messenger {
		...
		//
		// Emitting does not require a listener
		//
		#region Emit
		//No parameters
		static public void Emit(string eventType) {
			#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
			Debug.Log("MESSENGER\t" + System.DateTime.Now.ToString("hh:mm:ss.fff") + "\t\t Emit \t\"" + eventType + "\"");
			#endif
		...
		//Single parameter
		static public void Emit<T>(string eventType, T arg1) {
			#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
			Debug.Log("MESSENGER\t" + System.DateTime.Now.ToString("hh:mm:ss.fff") + "\t\t\Emit \t\"" + eventType + "\"");
			#endif
		...
		//Two parameters
		static public void Emit<T, U>(string eventType, T arg1, U arg2) {
			#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
			Debug.Log("MESSENGER\t" + System.DateTime.Now.ToString("hh:mm:ss.fff") + "\t\t\t Emit \t\"" + eventType + "\"");
			#endif
		...
		//Three parameters
		static public void Emit<T, U, V>(string eventType, T arg1, U arg2, V arg3) {
			#if LOG_ALL_MESSAGES || LOG_BROADCAST_MESSAGE
			Debug.Log("MESSENGER\t" + System.DateTime.Now.ToString("hh:mm:ss.fff") + "\t\t\t Emit \t\"" + eventType + "\"");
			#endif
